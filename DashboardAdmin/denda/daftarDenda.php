...
<html lang="en">
    ...
    <table class="table table-striped table-hover">
      ...
      <tr>
        ...
        <td class="text-center">
          <?php if ($item["denda"] > 0) : ?>
            <a href="formBayarDenda.php?id=<?= $item["id_pengembalian"]; ?>" class="btn btn-sm btn-success">Bayar</a>
          <?php else : ?>
  ...
  <footer class="fixed-bottom shadow-lg bg-subtle p-3">
      <div class="container-fluid d-flex justify-content-between">
         <p class="mt-2">Created by <span class="text-primary"> Kelompok 1</span> © 2025</p>
